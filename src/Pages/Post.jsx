...
function reducer(state, { type, payload }) {
  switch (type) {
    ...
    case "postDate":
      return { ...state, postDte: payload };
    case "totalOwners":
      return { ...state, totalOwners: payload };
    case "state":
    ...
    case "transmission":
      return { ...state, transmission: payload };
    case "product_desc":
      return { ...state, product_desc: payload };
    case "img":
...
export const Post = () => {
  ...
  return (
    <>
      <Heading fontSize={"24px"} fontWeight="700" color="#002f34">
        CREATE TRADE
      </Heading>
      <Box className={styles.box}>
        ...
        >
          <BreadcrumbItem>
            <BreadcrumbLink as={Link} to="/sell">
              ScrapPeer Auto (cars)
            </BreadcrumbLink>
          </BreadcrumbItem>
        ...
        <Box className={styles.formbox}>
          <form onSubmit={handleSubmit}>
            ...
            <select
              ...
              onChange={(e) =>
                setter({ type: "brand", payload: e.target.value })
              }
              required
            >
              <option value=""></option>
            ...
            <input
              className={styles.inputbox}
              onChange={(e) =>
                setter({ type: "model", payload: e.target.value })
              }
              required
            />
            <br />
            ...
            <select
              className={styles.inputbox}
              onChange={(e) =>
                setter({ type: "fuel", payload: e.target.value })
              }
              required
            >
              <option value=""></option>
            ...
            <select
              className={styles.inputbox}
              onChange={(e) =>
                setter({ type: "transmission", payload: e.target.value })
              }
              required
            >
              <option value=""></option>
            ...
            <input
              ...
              type="number"
              onChange={(e) =>
                setter({ type: "distance", payload: e.target.value })
              }
              required
            />
            <br />
            ...
            <select
              className={styles.inputbox}
              onChange={(e) =>
                setter({ type: "totalOwners", payload: e.target.value })
              }
              required
            >
              <option value=""></option>
            ...
            <textarea
              ...
              type="text"
              onChange={(e) =>
                setter({ type: "product_desc", payload: e.target.value })
              }
              required
            />
            <br />
            ...
            <input
              ...
              placeholder=" ₹ |"
              onChange={(e) =>
                setter({ type: "price", payload: e.target.value })
              }
              required
            />
            <br />
            ...
            <input
              ...
              type="text"
              onChange={(e) =>
                setter({ type: "state", payload: e.target.value })
              }
              required
            />
            <br />
            ...
            <input
              ...
              type="text"
              onChange={(e) =>
                setter({ type: "address", payload: e.target.value })
              }
              required
            />
            <br />
